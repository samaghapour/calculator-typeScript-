...
// variables
const operations = Array.from(document.getElementsByClassName('operation') as HTMLCollectionOf<HTMLElement>),
      ...
      swithBtn = document.getElementById('swithTheme')! as HTMLInputElement, // checkbox for switch theme
      calculate = new calculator(previousDiv,currentDiv),
      switchBox =Array.from( document.getElementsByClassName('switchBox') as HTMLCollectionOf<HTMLElement>)
